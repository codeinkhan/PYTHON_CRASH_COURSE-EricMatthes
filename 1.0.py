...
#1-1. python.org: Explore the Python home page (https://python.org to find topics
#     that interest you. As you become familiar with Python, different parts of
#     the site will be more useful to you.

#1-2. Hello World Typos: Open the hello_world.py file you just created. Make a typo
#     somewhere in the line and run the program again. Can you make a typo that
